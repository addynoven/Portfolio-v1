...
import RecentBlogs, {
	RecentBlogsSkeleton,
} from "@/components/v3/sections/recent-blogs";
...
import ComponentShowcase from "@/components/v3/sections/component-showcase";
			...
			<div className="max-w-5xl mx-auto px-4 sm:px-6">
				...
				<div className="flex items-start gap-10 mt-12">
					...
					<main className="flex-1 min-w-0">
						...
						<section
							id="hero"
							className="scroll-mt-24 v3-glass p-6 sm:p-8 rounded-2xl"
						>
						...
						<section
							id="skills"
							className="mt-16 scroll-mt-24 v3-glass p-6 sm:p-8 rounded-2xl"
						>
						...
						{/* ── Component Showcase ──────────────────────── */}
						<section id="components" className="mt-16 scroll-mt-24">
							<div className="flex items-center justify-between mb-8 group/title">
								<div className="flex items-center gap-3 flex-1">
									<h2 className="text-xl font-bold lowercase tracking-tight">
										{language === "jp" ? "コンポーネント" : "Components"}
									</h2>
									<div className="h-px flex-1 bg-border/50" />
								</div>
								<Link
