...
export default function Terminal() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[#0a0a0a]/95 to-[#0d1117]/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-[0_0_80px_-20px_rgba(0,255,153,0.25),0_0_30px_-10px_rgba(0,255,153,0.15)] w-full min-w-[380px] max-w-[520px] xl:min-w-[480px] xl:max-w-[560px] transition-all duration-300 cursor-text hover:border-white/20 hover:shadow-[0_0_100px_-20px_rgba(0,255,153,0.35),0_0_40px_-10px_rgba(0,255,153,0.2)]"
    >
      {/* Terminal Header */}
      <div className="bg-gradient-to-r from-[#0d1117] to-[#161b22] px-4 py-3 flex items-center gap-3 border-b border-white/10">
