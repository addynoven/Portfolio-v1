...
import Terminal from "@/components/v1/Terminal";
import Social from "@/components/v1/Social";
import Stats from "@/components/v1/Stats";
import { Button } from "@/components/ui/button";
import HeroTiltCard from "@/components/v1/HeroTiltCard";
...
import { LazyRender } from "@/components/v1/LazyRender";
import { usePerformance } from "@/hooks/usePerformance";
import { useSiteName } from "@/hooks/useSiteName";

// Lazy load heavy Three.js and animation components
const ParticleBackground = dynamic(
  () => import("@/components/v1/ParticleBackground"),
  { ssr: false }
);
const FloatingCodeSymbols = dynamic(
  () => import("@/components/v1/FloatingCodeSymbols"),
  { ssr: false }
);
